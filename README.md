...
pip install "alterable-skills @ git+https://github.com/altertable-ai/skills.git"

# From a release tag
pip install "alterable-skills @ git+https://github.com/altertable-ai/skills.git@v0.1.0"
```
