...
import fire
from scorer import DEFAULT_MODEL, format_cli, format_pr_comment, score_batch
from scorer.models import DEFAULT_MIN_SCORE, SKILL_FILENAME
...
def score(
    *paths: str,
    ...
    Args:
        ...
        model: LLM model (default: gemini/gemini-flash-latest)
    ...
    try:
        results = asyncio.run(score_batch(skill_paths, model))
