...
**This skill vs. forecast tasks:** This skill runs *on-demand, local analysis* using Python tools (Chronos, statsmodels). For *recurring, automated* forecasting on a schedule, use the **configure-tasks** skill to create a `forecast` task instead.
