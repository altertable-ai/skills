...
Use `creating-insights` for saved charts, tables, funnels, cohorts, or semantic visualizations. Use `managing-discoveries` for approval, rejection, and feedback after a discovery exists.
